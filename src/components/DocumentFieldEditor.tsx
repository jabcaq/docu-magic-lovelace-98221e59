...
const DocumentFieldEditor = ({
  ...
  return (
    <div
      className={`space-y-3 p-4 rounded-lg border-2 transition-all duration-200 ${
        isHighlighted
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <Badge
            variant="outline"
            className="text-[10px] font-mono bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800"
          >
            {field.tag}
          </Badge>
        </div>
